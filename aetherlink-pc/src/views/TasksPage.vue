            ...
            <section class="tasks-header-section">
                <div class="tasks-header">
                    ...
                    <div class="header-buttons">
                        <button class="sm" @click="loadProfiles">
                            ⟳ Обновить
                        </button>
                ...
                <div class="tasks-container">
                    <div class="profile" v-for="profile in profiles">
                        ...
                        <div class="profile-btns">
                            ...
                            <button
                                class="sm"
                                @click="runProfile(profile.id, profile.name)"
                            >
                                Запустить
                            </button>
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select v-model="newTask.type">
                                ...
                                <option value="run_exe">
                                    Запуск программы
                                </option>
                                <option value="power_shell">
                        ...
                        <div
                            class="form-group"
                            v-if="newTask.type !== 'power_shell'"
                        >
                            <label>Путь к файлу / Запуск команды</label>
                            <input
